...
Public Class GatherGameMain
    ...
    Private Sub FoodButton_Click(sender As Object, e As EventArgs) Handles FoodButton.Click
        ...
        If actionNumber <> 0 Then
            ...
            If stoneShovel = True Then
                randomInteger += 5
            End If
            If ironShovel = True Then
                randomInteger += 10
            End If
            If goldShovel = True Then
                randomInteger += 25
            End If
            ...
            If foodEvent = True Then
                ...
                foodEventAmount = (randomInteger * 2)
    ...
    Private Sub WoodButton_Click(sender As Object, e As EventArgs) Handles WoodButton.Click
        ...
        If actionNumber <> 0 Then
            ...
            System.Threading.Thread.Sleep(2000)
            randomInteger = randNum.Next(1, 6)
            If stoneAxe = True Then
                randomInteger += 5
            End If
            If ironAxe = True Then
                randomInteger += 10
            End If
            ...
            If woodEvent = True Then
                ...
                woodEventAmount = (randomInteger * 2)
    ...
    Private Sub StoneButton_Click(sender As Object, e As EventArgs) Handles StoneButton.Click
        ...
        If actionNumber <> 0 Then
            ...
            System.Threading.Thread.Sleep(2000)
            randomInteger = randNum.Next(1, 6)
            If stonePickaxe = True Then
                randomInteger += 5
            End If
            If ironPickAxe = True Then
                randomInteger += 10
            End If
            If goldPickaxe = True Then
                randomInteger += 25
            End If
            If stoneEvent = True Then
                stoneEventYes = randFoodEvent.Next(1, 10)
                stoneEventAmount = (randomInteger * 2)
